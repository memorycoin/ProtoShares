...
#ifndef H_MEMORYCOIN_SCRIPT
#define H_MEMORYCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CMemorycoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Memorycoin always counted CHECKMULTISIGs
