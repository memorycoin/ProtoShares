...
{
    return QCoreApplication::translate("memorycoin-core", psz).toStdString();
}
...
int main(int argc, char *argv[])
{
   ...
   // QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
    ...
    QApplication::setOrganizationName("MemoryCoin");
    QApplication::setOrganizationDomain("http://memorycoin.org/");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("MemoryCoin-Qt-testnet");
    else
        QApplication::setApplicationName("MemoryCoin-Qt");
