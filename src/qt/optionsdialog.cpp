    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new MemorycoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->memorycoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting MemoryCoin."), QMessageBox::Ok);
