// Copyright (c) 2013-2014 Memorycoin Dev Team// Copyright (c) 2009-2010 Satoshi Nakamoto
             ...
             bool& fIsEncrypted,  bool& fAnyUnordered, string& strType, string& strErr)
{
    try {
        ...
        if (strType == "name")
        {
            string strAddress;
            ssKey >> strAddress;
            ssValue >> pwallet->mapAddressBook[CMemorycoinAddress(strAddress).Get()];
        }
        else if (strType == "tx")
        {
            uint256 hash;
...
void ThreadFlushWalletDB(const string& strFile)
{
    ...
    RenameThread("memorycoin-wallet");
